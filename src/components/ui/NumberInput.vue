...
<template>
  <div class="input-group w-full" data-input-number>
    <span class="input-group-text border-base-content/25 border-e ps-0">
      <button type="button" class="flex size-12 items-center justify-center" aria-label="Decrement button" @click="decrement">
    ...
    <div class="absolute bottom-1 start-1/2 flex -translate-x-1/2 items-center rtl:translate-x-1/2">
      ...
      <span class="text-xs text-base-content/80 text-nowrap">{{ label }}</span>
    </div>
    <span class="input-group-text border-base-content/25 border-s pe-0">
      <button type="button" class="flex size-12 items-center justify-center" aria-label="Increment button" @click="increment">
